...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ ᴋᴇᴘᴛʜᴏɴ 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/kepthon)父**"
...
def jmthonalive_text():
    ...
    jmthon_caption += f"**{EMOJI} اصدار سيثـون كرستال :** `{jmthonversion}`\n"
...
ROZ_PIC = "https://graph.org/file/a5e30a74f7364dd514c7b.jpg"
RAZAN = Config.TG_BOT_USERNAME
ROZ_T = (
    f"**⌯︙بوت سيثـون كرستاليعمل بنجاح 🤍،**\n"
    f"**   - اصدار  كرستال :** `1.23.0\n`"
    f"**   - اصدار سيثـون كرستال:** `4.0.0`\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == sbb_b.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/no1bros"),
                    Button.url("المطـور 👨🏼‍💻", "https://t.me/ssxhh"),
                ]
            ]
