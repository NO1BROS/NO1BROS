...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("تنصيب دراكـو", "https://t.me/no1bros"),
                Button.url(
                    "مساعدة ❓",
                    "https://t.me/ppblb",
                ),
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/kepthon"),
            ],
            [
...
قناة سورس سيثـون كرستال @no1bros""",
        buttons=[
