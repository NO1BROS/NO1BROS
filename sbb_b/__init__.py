...
__author__ = "سورس سيثون كرستال<https://github.com/NO1BROS/NO1BROS>"
__copyright__ = f" حقوق سورس سيثون كرستال(C) 2020 - 2022  {__author__}"

sbb_b.version = __version__
sbb_b.tgbot.version = __version__
LOGS = logging.getLogger("سورس سيثون كرستال")
bot = sbb_b
tbot = tgbot
